...
description: Provides distinctive, intentional frontend design guidance for building or redesigning web interfaces. Use when creating React or web UI, designing pages, improving visual hierarchy, typography, layouts, responsive behavior, interaction design, animations, or visual polish.
...
When building React interfaces:

- Use Tailwind CSS for styling.
- Use shadcn/ui for foundational interface components.
- Use Motion for component-level transitions and micro-interactions.
- Use GSAP for complex timelines, scroll-driven experiences, and choreography.
- Use Rive for interactive illustrations and stateful animations.
- Use Three.js / React Three Fiber only when 3D materially improves the experience.
- Prefer CSS transitions for simple state changes where Motion is unnecessary.

Do not introduce a library merely to create a visual effect.

## Motion Hierarchy

Choose the simplest technology capable of achieving the intended interaction.
...
- complex animated UI graphics

### Level 5 — Three.js
Use only when:
- 3D is central to the product concept
- spatial relationships need visualization
- an interactive 3D object materially improves understanding
...
- "01 / 02 / 03" decorative numbering
- gradient text used merely to signal AI

## Design Review Loop

Before considering a frontend task complete:

1. Understand the product and target user.
2. Define the visual direction.
3. Create a compact design token system.
4. Sketch the page structure.
5. Implement the first pass.
6. Run the application.
7. Inspect the rendered UI in the browser.
8. Compare the implementation against the intended design.
9. Identify the three largest visual problems.
10. Fix those problems.
